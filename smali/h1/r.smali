...
# static fields
.field public static final a:Lh1/r$b;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lh1/r$b;

    invoke-direct {v0}, Lh1/r$b;-><init>()V

    sput-object v0, Lh1/r;->a:Lh1/r$b;
    ...
    new-instance v0, Lh1/r$e;

    invoke-direct {v0}, Lh1/r$e;-><init>()V

    invoke-virtual {v1, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 2
    sput-object v1, Lh1/r;->d:Ljava/util/ArrayList;
    ...
    new-instance v2, Lh1/r$c;

    invoke-direct {v2}, Lh1/r$c;-><init>()V

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    sget-object v2, Lh1/r;->d:Ljava/util/ArrayList;
    ...
    .line 4
    sput-object v0, Lh1/r;->c:Ljava/util/HashMap;
    ...
    sput-object v0, Lh1/r;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sput-object v0, Lh1/r;->b:Ljava/util/List;

    return-void
.end method

.method public static a(Lh1/r$d;)Ljava/util/TreeSet;
    .registers 10
    ...
    .line 5
    invoke-virtual {p0}, Lh1/r$d;->a()Ljava/lang/String;
    ...
    sget-object v5, Le1/r;->c:Landroid/content/Context;
...
.method public static b(Le1/m;)Landroid/os/Bundle;
    .registers 4
    ...
    invoke-virtual {p0}, Le1/m;->toString()Ljava/lang/String;
...
.method public static c(Landroid/content/Intent;Landroid/os/Bundle;Le1/m;)Landroid/content/Intent;
    .registers 7

    invoke-static {p0}, Lh1/r;->e(Landroid/content/Intent;)Ljava/util/UUID;
    ...
    invoke-static {p2}, Lh1/r;->b(Le1/m;)Landroid/os/Bundle;
...
.method public static e(Landroid/content/Intent;)Ljava/util/UUID;
    .registers 4
...
.method public static f(Landroid/os/Bundle;)Le1/m;
    .registers 3
    ...
    invoke-direct {p0, v1}, Le1/n;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, Le1/m;-><init>(Ljava/lang/String;)V
...
.method public static g(Ljava/util/List;[I)I
    ...
    check-cast v1, Lh1/r$d;

    .line 1
    iget-object v2, v1, Lh1/r$d;->a:Ljava/util/TreeSet;
    ...
    invoke-static {v1}, Lh1/r;->a(Lh1/r$d;)Ljava/util/TreeSet;

    move-result-object v2

    iput-object v2, v1, Lh1/r$d;->a:Ljava/util/TreeSet;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_3
    :goto_0
    iget-object v1, v1, Lh1/r$d;->a:Ljava/util/TreeSet;
...
.method public static final h()I
    ...
    sget-object v0, Lh1/r;->b:Ljava/util/List;
...
.method public static k(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;ILandroid/os/Bundle;)V
    .registers 9
    ...
    sget-object v1, Le1/r;->e:Ljava/lang/String;
    ...
    invoke-static {p2, p1, v1}, Lh1/x;->y(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static l()V
    ...
    sget-object v0, Lh1/r;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    new-instance v1, Lh1/r$a;

    invoke-direct {v1}, Lh1/r$a;-><init>()V
...
.method public static m(Landroid/content/Context;Landroid/content/Intent;Lh1/r$d;)Landroid/content/Intent;
    .registers 6
    ...
    invoke-virtual {p2, p0, v1}, Lh1/r$d;->b(Landroid/content/Context;Ljava/lang/String;)Z
