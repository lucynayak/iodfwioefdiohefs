...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    # On API 30+: request MANAGE_EXTERNAL_STORAGE if not granted
    const/16 v0, 0x1e

    if-lt p1, v0, :cond_old_perms
    ...
    # Don't proceed — wait for user to grant and return
    const/4 v0, 0x1
    sput-boolean v0, Ldev/virus/variable/app/MainActivity;->sAwaitingPermission:Z

    return-void

    # API 23-29: use old storage permissions
    :cond_old_perms
    const/16 v0, 0x17
...
.method protected onRestart()V
    ...
    # If we were waiting for the user to grant all-files permission, re-check
    sget-boolean v0, Ldev/virus/variable/app/MainActivity;->sAwaitingPermission:Z
    if-eqz v0, :skip

    # Clear flag first to prevent infinite loop
    const/4 v0, 0x0
    sput-boolean v0, Ldev/virus/variable/app/MainActivity;->sAwaitingPermission:Z

    # Re-run onCreate by recreating the activity
...
.method public final onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    .line 2
    :cond_0
    # Permission denied — just proceed instead of re-requesting (avoids infinite loop)
    const p2, 0x7f0b001e
