...
.method public final onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_edit
    # Get LayoutParams (set by WindowManager.addView -> WindowManager$LayoutParams)
    ...
    :pswitch_move
    # newX = downParamsX + (rawX - downRawX)
    invoke-virtual {p2}, Landroid/view/MotionEvent;->getRawX()F
    ...
    # newY = downParamsY + (rawY - downRawY)
    invoke-virtual {p2}, Landroid/view/MotionEvent;->getRawY()F
    ...
    :try_end_move
    .catch Ljava/lang/Exception; {:try_start_move .. :try_end_move} :catch_move
    ...
    :pswitch_up
    # Save final window position to SharedPreferences
    invoke-virtual {p1}, Landroid/view/View;->getContext()Landroid/content/Context;
