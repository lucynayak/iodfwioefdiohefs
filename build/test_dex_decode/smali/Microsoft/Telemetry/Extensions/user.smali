...
.method public getField(Lcom/microsoft/bond/FieldDef;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object p1, p0, LMicrosoft/Telemetry/Extensions/user;->authId:Ljava/lang/String;

    return-object p1

    :cond_1
    iget-object p1, p0, LMicrosoft/Telemetry/Extensions/user;->localId:Ljava/lang/String;

    return-object p1

    :cond_2
    iget-object p1, p0, LMicrosoft/Telemetry/Extensions/user;->id:Ljava/lang/String;
...
.method public memberwiseCompare(Ljava/lang/Object;)Z
    ...
    :cond_0
    check-cast p1, LMicrosoft/Telemetry/Extensions/user;

    invoke-virtual {p0, p1}, LMicrosoft/Telemetry/Extensions/user;->memberwiseCompareQuick(LMicrosoft/Telemetry/Extensions/user;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, LMicrosoft/Telemetry/Extensions/user;->memberwiseCompareDeep(LMicrosoft/Telemetry/Extensions/user;)Z
...
.method public memberwiseCompareDeep(LMicrosoft/Telemetry/Extensions/user;)Z
    .locals 4
    ...
    :cond_1
    iget-object v3, p1, LMicrosoft/Telemetry/Extensions/user;->id:Ljava/lang/String;
    ...
    :cond_4
    iget-object v3, p1, LMicrosoft/Telemetry/Extensions/user;->localId:Ljava/lang/String;
    ...
    :cond_7
    iget-object p1, p1, LMicrosoft/Telemetry/Extensions/user;->authId:Ljava/lang/String;
...
.method public memberwiseCompareQuick(LMicrosoft/Telemetry/Extensions/user;)Z
    .locals 4
    ...
    :goto_d
    iget-object v3, p1, LMicrosoft/Telemetry/Extensions/user;->authId:Ljava/lang/String;
...
.method public writeNested(Lcom/microsoft/bond/ProtocolWriter;Z)V
    ...
    iget-object v2, p0, LMicrosoft/Telemetry/Extensions/user;->id:Ljava/lang/String;
    ...
    iget-object v2, p0, LMicrosoft/Telemetry/Extensions/user;->localId:Ljava/lang/String;
