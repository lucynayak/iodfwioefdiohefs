...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lo0/p;->a:Landroid/widget/ProgressBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lo0/p;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lo0/p;->c:[I
    ...
    iget-object v2, p0, Lo0/p;->a:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v1}, Lo0/p;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lo0/s0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, p0, Lo0/p;->a:Landroid/widget/ProgressBar;

    invoke-virtual {p0, v0, p2}, Lo0/p;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v1, p2}, Lo0/p;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Lo0/p;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lo0/p;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Lo0/p;->b:Landroid/graphics/Bitmap;
