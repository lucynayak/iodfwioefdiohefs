...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "CERTNET"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;->CERTNET:Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    new-instance v5, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    const-string v7, "PARTNERNET"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;->PARTNERNET:Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    new-instance v7, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    const-string v9, "PROD"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;->PROD:Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    new-instance v9, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    const-string v11, "DNET"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;->DNET:Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;
    ...
    sput-object v11, Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;->$VALUES:[Lcom/microsoft/xbox/toolkit/network/XboxLiveEnvironment$Environment;
